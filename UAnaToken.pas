...
opCLOSE = opUserDefined		+108;
 ...
 GRAPH_OPTIONS = ' BW BY TEXT EDIT XLABEL N TI SUB SAVE LEGEND NOLEGEND FRAME HGRID VGRID XHIDE YHIDE' +
                 ...
                 ' XLINED YLINED YVALUE XINC YINC X90 X45 XA NT FN REPLACE SIZEX SIZEY NG';
 ...
 AGGR_STAT_OPTIONS =  ' MEAN SD SV MEDIAN SUM MIN MAX P5 P10 P25 P50 P75 P90 P95 P99 ISR IQR IDR DES MV ';
