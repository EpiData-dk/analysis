...
const
  ...
  ANA_SO_FORMAT_VALUE_LABEL            = 'STATISTICS VALUE LABEL';
  ANA_SO_FORMAT_VARIABLE_LABEL         = 'STATISTICS VARIABLE LABEL';
  ANA_SO_BROWSE_VALUE_LABEL            = 'BROWSE VALUE LABEL';
  ANA_SO_BROWSE_VARIABLE_LABEL         = 'BROWSE VARIABLE LABEL';
