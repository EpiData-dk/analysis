...
begin
  ...
  case Currenttoken.TokenSubType of
    ...
    opShortLifeTable,opLifeTable: result := ParseTypicalCommand(Currenttoken.TokenSubType, [PCAllowVarList,PCAllowIf], Gnrl_options + PCT_OPTIONS + GRAPH_OPTIONS + ' BY W END G NOCI NOLT T I O CLOSE EXIT MT');
