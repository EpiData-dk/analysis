...
uses
  ...
  StdCtrls, describe_variable_model, fields_combobox, stat_dialog_custom_view;
//  freq_variable_view;
...
begin
  for i := Low(FComboBoxes) to High(FComboBoxes) do
    begin
      ...
      ComboBox.Fields := nil;
      ComboBox.Fields := FDataModel.GetComboFields(TDescribeVariable(i));
...
begin
  ...
  SetLength(FComboBoxes, Ord(High(TDescribeVariable)) + 1);
