...
uses
  ...
  sysutils, Forms, epidatacore, FrameViewer09, lclextensions_package, lnetbase,
  main, executor, expr, ast, ast_types, ast_builder, datamodule, select_stack,
  result_variables, runtest, parser, about, statfunctions, means, generalutils,
  interval_types, outputcreator, outputgenerator_base, outputgenerator_txt,
  outputgenerator_html, options_hashmap, list, edit, drop, history, cmdedit,
  analysis_statusbar, selected_count_statusbar_item, workingdir_statusbar_item,
  systemcmd, parser_types, Variables, Token, Symbol, SourceFeeder, Rule,
  MemLeakFinder, LRAction, GrammarReader, GOLDParser, FAState,
