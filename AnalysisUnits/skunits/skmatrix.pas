...
const
  ...
  TNArraySize = 40; //30;               { Size of the matrix }
  CO          = 0.3989422804014327;
  BIGX        = 170;
...
PROCEDURE MEANVALUE_TEST(NGROUPS    : BYTE;
                         MEANVALUES : RVECTOR;
                         VARIANCES  : RVECTOR;
                     VAR MEAN       : REAL;
                     VAR VARIANCE   : REAL;
...
(* IN DIFFERENT GROUPS WITH DIFFERENT VARTIANCES             *)
(*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*)
...
(*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*)
(* THIS PROCEDURE CALCULATES A TEST FOR HOMOGENEITY OF TWO   *)
(* MEANS WITH DIFFERENT VARIANCES AND CALCULATES THE LSE     *)
(* ESTIMATES                                                 *)
(*+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*)
...
BEGIN
    ...
    //IF NGRP<NGROUPS THEN WRITELN('Groups with zero variance');

    IF DF<1 THEN
    BEGIN
        //WRITELN('No degrees of freedom');
        GOTO SLUT;
    END;
