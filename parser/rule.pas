...
type
   ...
   public
     ...
     function Definition: UTF8String;
     function ContainsOneNonTerminal: Boolean;
     function Text: UTF8String;
...
function TRule.Name: UTF8String;
begin
...
function TRule.Definition: UTF8String;
var i : integer;
begin
  Result := '';
...
function TRule.Text: UTF8String;
begin
