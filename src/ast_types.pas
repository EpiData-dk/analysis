...
const
  ASTGraphCommands: TASTStatementTypes = [stScatter, stSurvival, stEpiCurve, stHistogram, stFBarchart, stPareto];
  ASTVLabelCommands: TASTStatementTypes = [stTables, stCTable, stBrowse, stAggregate, stFreq, stDescribe,
                                           stScatter, stSurvival, stEpiCurve, stHistogram, stFBarchart,
                                           stPareto];
