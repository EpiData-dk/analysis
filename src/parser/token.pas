...
type
  ...
  private
    ...
    function GetKind: TGoldSymbolKind;
    function GetName: UTF8String;
    procedure SetParentSymbol(Value: TSymbol);
    procedure SetdataVar(Value: UTF8String);
  ...
  public
    constructor Create(ALineNum, ACaretNum, ABytePos: Integer);
    destructor Destroy; override;
    // Returns an enumerated data type that denotes the symbol class of the token.
    property Kind : TGoldSymbolKind read GetKind;
    ...
    property DataVar : UTF8String read FDataVar write SetDataVar;
    ...
    // The token was identified at this line
    property LineNum: Integer read FLineNum;
    // The token was identified at this Character position (not byte-position).
    property CaretNum: Integer read FCaretNum;
    // The tokens was identified at this absolute byte-position
...
constructor TToken.Create(ALineNum, ACaretNum, ABytePos: Integer);
begin
  inherited Create;
  FDataVar := '0';
  FLineNum := ALineNum;
...
function TToken.GetKind: TGoldSymbolKind;
begin
  Result := ParentSymbol.Kind;
end;

function TToken.GetName: UTF8String;
begin
...
procedure TToken.SetdataVar(Value: UTF8String);
begin
  FDataVar := Value;
end;
...
function TToken.GetText: UTF8String;
begin
