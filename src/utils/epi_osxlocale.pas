{
    NOTE: This unit should be deleted when it is included in Core/Utils
    
    unit renamed from the original (iosxlocale) and modified 
    to correctly identify 'y' in a date format as meaning 'yyyy' 
    (MacOS 11 or greater?)
            ...
            if (p+1)^=c then
              ...
              begin
                case c of
                  ...
                  'm':
                    begin
                      c:='m';   //* Why was this 'n'? It works, but is confusing; prefer 'm' for month digits
                      if cnt>2 then
                        cnt:=2;
                    end;
                  's':
