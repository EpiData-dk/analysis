...
uses
  ...
  StdCtrls, tables_model, fields_combobox, stat_dialog_custom_view;
...
begin
  for i := Low(FComboBoxes) to High(FComboBoxes) do
    begin
      ...
      ComboBox.Fields := nil;
      ComboBox.Fields := FDataModel.GetComboFields(TTableStatDialogVariable(i));
...
begin
  ...
  SetLength(FComboBoxes, Ord(High(TTableStatDialogVariable)) + 1);
